...
#define   BF_P1MDIN      0         // Analog Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDIN_0    0         // Analog Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDIN_1    1         // Analog Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDIN_2    2         // Analog Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDIN_3    3         // Analog Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDIN_4    4         // Analog Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDIN_5    5         // Analog Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDIN_6    6         // Analog Configuration Bits for P1.6–P1.0 (respectively).
#define   M_P1MDIN       0x7F      // Analog Configuration Bits for P1.6–P1.0 (respectively).

// SFR Definition 21.16. P1MDOUT: Port1 Output Mode
#define   BF_P1MDOUT     0         // Output Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDOUT_0   0         // Output Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDOUT_1   1         // Output Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDOUT_2   2         // Output Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDOUT_3   3         // Output Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDOUT_4   4         // Output Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDOUT_5   5         // Output Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1MDOUT_6   6         // Output Configuration Bits for P1.6–P1.0 (respectively).
#define   M_P1MDOUT      0x7F      // Output Configuration Bits for P1.6–P1.0 (respectively).

// SFR Definition 21.17. P1DRV: Port1 Drive Strength
#define   BF_P1DRV       0         // Drive Strength Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1DRV_0     0         // Drive Strength Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1DRV_1     1         // Drive Strength Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1DRV_2     2         // Drive Strength Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1DRV_3     3         // Drive Strength Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1DRV_4     4         // Drive Strength Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1DRV_5     5         // Drive Strength Configuration Bits for P1.6–P1.0 (respectively).
#define   BF_P1DRV_6     6         // Drive Strength Configuration Bits for P1.6–P1.0 (respectively).
#define   M_P1DRV        0x7F      // Drive Strength Configuration Bits for P1.6–P1.0 (respectively).
...
#define   BF_SBUF0       0         // Serial Data Buffer Bits 7:0 (MSB–LSB).
#define   BF_SBUF0_0     0         // Serial Data Buffer Bits 7:0 (MSB–LSB).
#define   BF_SBUF0_1     1         // Serial Data Buffer Bits 7:0 (MSB–LSB).
#define   BF_SBUF0_2     2         // Serial Data Buffer Bits 7:0 (MSB–LSB).
#define   BF_SBUF0_3     3         // Serial Data Buffer Bits 7:0 (MSB–LSB).
#define   BF_SBUF0_4     4         // Serial Data Buffer Bits 7:0 (MSB–LSB).
#define   BF_SBUF0_5     5         // Serial Data Buffer Bits 7:0 (MSB–LSB).
#define   BF_SBUF0_6     6         // Serial Data Buffer Bits 7:0 (MSB–LSB).
#define   BF_SBUF0_7     7         // Serial Data Buffer Bits 7:0 (MSB–LSB).
#define   M_SBUF0        0xFF      // Serial Data Buffer Bits 7:0 (MSB–LSB).
